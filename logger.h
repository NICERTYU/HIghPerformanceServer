...
#define    SUPERG_LOG_NAME(name)  superG::LogMng::GetInstance()->getLogger(name)
...
namespace superG
{
    ...
    public:
        ...
        void setFormmater(LogFormmatter::ptr formmatter);
      const bool getHasFormatter() const {return has_formatter;}
        void setHasFormatter(bool val){has_formatter=val;}
        LogFormmatter::ptr getFormmatter();
        LogLevel::Level getLevel() const {return m_level;};
...
class Logger:public std::enable_shared_from_this<Logger>
    ...
    public:
        ...
        void setFormmater(const  std::string& val);
        void setFormmater(LogFormmatter::ptr val);
        LogFormmatter::ptr getFormmater();
    ...
    class NameFormatItem:public LogFormmatter::FormatItem
    {
    public:
        NameFormatItem(const std::string str): LogFormmatter::FormatItem(str){};
